    ...
    >
      ...
      <div className={styles['field-container']}>
        ...
        <input
          type="text"
          name="name"
          value={name} //makes state drive the input
          onChange={(e) => setName(e.target.value)} //pushes every keystroke into state
          onFocus={() => setTouched((prev) => ({ ...prev, name: true }))} //when the user clicks, flips name to true
